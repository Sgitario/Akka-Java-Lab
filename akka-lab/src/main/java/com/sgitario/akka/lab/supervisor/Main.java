package com.sgitario.akka.lab.supervisor;
...
import com.sgitario.akka.lab.supervisor.actors.SupervisorActor;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		log.info("Sending value 8, it should receive 9 after worker processing... ");
		...
		assert result.equals(Integer.valueOf(9));
		...
		supervisor.tell("Nothing", ActorRef.noSender());
